        ...
        if (stateLabel.text == "Recording") {
                ...
                let okayAction =
                    UIAlertAction(title: "Switch to fast rewinding",
                        style: .default) { _ in
                            let confirmAlertController = UIAlertController(title: "Now switching to fast rewinding.",
                                message: nil,
                                preferredStyle: .alert)
        ...
        if (stateLabel.text != "Recording" && stateLabel.text != "Stopped") {
                ...
                let okayAction =
                    UIAlertAction(title: "Switch to recording",
                        style: .default) { _ in
                            let confirmAlertController = UIAlertController(title: "Now switching to recording",
                                message: nil,
                                preferredStyle: .alert)
